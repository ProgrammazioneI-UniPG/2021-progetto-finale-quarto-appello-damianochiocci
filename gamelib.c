...
void Set_Game() {
 ...
 if (total_quest < players_number || total_quest > 20) {
   while (total_quest < players_number || total_quest > 20) {
...
//Function to restart the number of turns
static void cleaning(){
  static int reset;
  printf("\nPress a number to skip: ");
  scanf("%d", &reset);
  switch(reset){
    default:
      system("clear");
